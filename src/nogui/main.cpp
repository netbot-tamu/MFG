...
double THRESH_POINT_MATCH_RATIO = 0.50; // SIFT distance threshold

// SIFT
double SIFT_THRESH_HIGH = 0.05;
double SIFT_THRESH_LOW  = 0.03;
...
int main(int argc, char *argv[])
{
    ...
    int ini_incrt = mfgSettings->getFrameStepInitial(); // first frame step
    int increment = mfgSettings->getFrameStep();		// frame step
    int totalImg = 12500;   // total num of frames
    string imgName;			// first frame name
