...
int main(int argc, char *argv[])
{
   ...
   MfgSettings config; // TODO: arg-parse a cameraID (optional arg)
   ...
   syspara.use_img_width = config.getImageWidth();
   std::cout << "K =\n" << K << std::endl;
   std::cout << "distCoeffs =\n" << distCoeffs << std::endl;
   std::cout << "use_img_width = " << syspara.use_img_width << std::endl;
